...
function eq_less()
{
	wp_enqueue_style('less-style-09', get_stylesheet_directory_uri() . '/includes/09/less/09.less', array(), null, 'all');
	wp_enqueue_style('less-style-15', get_stylesheet_directory_uri() . '/includes/15/less/15.less', array(), null, 'all');
}
