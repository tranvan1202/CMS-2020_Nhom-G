    	...
    	<div class="cover-type68">
    		<div class="row">
                ...
                <div class="col-md-5">
                    <div class="img">
                        <a href="#">
                            <img loading="lazy" class="alignnone wp-image-61 size-full" src="http://<?php echo $url_path ?>/images/37.jpg" width="396" height="223" alt="37"style="cursor: zoom-in;"/>
                        </a>
                    </div>
                    <div class="img">
                        <a href="#">
                            <img loading="lazy" class="alignnone wp-image-61 size-full" src="http://<?php echo $url_path ?>/images/25.jpg" width="396" height="223" alt="25"style="cursor: zoom-in;"/>
                        </a>
                    </div>
                    <div class="img">
                        <a href="#">
                            <img loading="lazy" class="alignnone wp-image-61 size-full" src="http://<?php echo $url_path ?>/images/17.jpg" width="396" height="223" alt="17"style="cursor: zoom-in;"/>
                        </a>
                    </div>
                </div>
            </div>
