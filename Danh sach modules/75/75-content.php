		...
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<div class="special_offer">
						<div class="special-offer__image">
							<img class="img-fluid" src="http://<?php echo $url_path ?>/images/con-rua.jpg" alt="Hình con rùa"/>
						</div>
				...
				<div class="col-md-6">
					<div class="special_offer">
						<div class="special-offer__image">
							<img class="img-fluid" src="http://<?php echo $url_path ?>/images/women.jpg" alt="Hình phụ nữ"/>
						</div>
						<div class="special-offer__content">
							<div class="special-offer__label">FEB - OCT</div>
