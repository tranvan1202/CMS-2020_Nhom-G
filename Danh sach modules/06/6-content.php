                    ...
                    <div class="panel-grid-cell">
                        <div class="cover_content">
                            <a class="page-box__picture" href="#">
                                <img src="http://<?php echo $url_path ?>/images/girl.jpg" width="352" height="198" class="wp-post-image" alt="Surfing">
                            </a>
                            <div class="page-box__content">
                                <h4 class="page-box__title">
                                    <a href="https://demo.proteusthemes.com/shaka/services/learn-how-to-surf/">Surfing</a>
                                </h4>
