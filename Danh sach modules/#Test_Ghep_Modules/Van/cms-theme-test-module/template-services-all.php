    ...
    <div class="type-22">
        <div class="container">
            ...
            <div class="type-22__breadcrumb">
                ...
                <div>
                    <a class="type-22__breadcrumb__item-primary" href="#">Services</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="type-33 type-33-all-services">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="widget_product_categories">
                        <ul class="product-categories">
                            <li class="cat-item cat-item-active"><a href="./services">All Services</a></li>
                ...
                <div class="col-md-8">
                    <div class="type-6 type-6-for-services">
                        <div class="container">
