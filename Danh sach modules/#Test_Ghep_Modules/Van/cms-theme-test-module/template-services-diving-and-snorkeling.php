<?php
/*
Template Name: DIVING AND SNORKELING
*/
    ...
    <div class="type-22">
        <div class="container">
            ...
            <div class="type-22__breadcrumb">
                ...
                <div>
                    <a class="type-22__breadcrumb__item-primary" href="#">Shaka -> DIVING AND SNORKELING</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-4">
                    <div class="widget_product_categories">
                        <ul class="product-categories">
                            ...
                            <li class="cat-item cat-item-active"><a href="./services/diving-and-snorkeling">DIVING AND SNORKELING</a></li>
