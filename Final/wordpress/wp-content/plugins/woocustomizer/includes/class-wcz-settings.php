			...
			$settings['wcz_catalogue'] = array(
				...
				'fields'      => array(
					array(
						...
						'description' => __( 'Upgrade from only <b>$39</b> to unlock these extra Pro features', 'woocustomizer' ),
						'type'        => 'promo',
						'default'     => '',
			...
			$settings['wcz_handheld_footer'] = array(
				...
				'fields'      => array(
					array(
						...
						'description' => 'Upgrade from only <b>$39</b> to unlock these extra Pro features',
						'type'        => 'promo',
                        'default'     => '',
